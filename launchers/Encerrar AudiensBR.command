#!/bin/bash
# Encerra o AudiensBR Fit e descarrega os modelos da RAM.
# Porta dedicada 11435: nunca manda descarregar modelos do Ollama de outro
# app (ex.: o AudiensBR completo, que pode estar em análise nesse momento).
...
echo "AudiensBR Fit encerrado e RAM liberada. Pode fechar esta janela."
